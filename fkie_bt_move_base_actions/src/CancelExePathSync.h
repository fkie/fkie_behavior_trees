...
#ifndef MOVE_BASE_CANCEL_EXE_PATH_SYNC_H
#define MOVE_BASE_CANCEL_EXE_PATH_SYNC_H
...
{
class CancelExePathSync : public BT::ActionNodeBase
{
public:
  std::string topic_exe_path;
  bool is_initialized = false;

  CancelExePathSync(const std::string& name, const BT::NodeConfiguration& config);
  ~CancelExePathSync();
  ...
  {
    static BT::PortsList ports = { BT::OutputPort<Pose2D>("target_pose"), BT::OutputPort<nav_msgs::Path>("path") };
...
#endif  // MOVE_BASE_CANCEL_EXE_PATH_SYNC_H
